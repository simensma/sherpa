...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        import re
        for content in orm.Content.objects.filter(content__contains=' class="external"'):
            content.content = re.sub(' class="external"', '', content.content)
            content.save()

    def backwards(self, orm):
        print("This migration is irreversible; ignoring.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 27, 16, 42, 23, 265918)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 27, 16, 42, 23, 265761)'}),
