...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_unique('page_page', ['slug'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 6, 16, 9, 6, 34464)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 6, 16, 9, 6, 34293)'}),
