...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ad.viewcounter'
        db.add_column('page_ad', 'viewcounter', self.gf('django.db.models.fields.CharField')(default='', max_length=2048), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ad.viewcounter'
        db.delete_column('page_ad', 'viewcounter')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 9, 51, 35, 355622)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 9, 51, 35, 355454)'}),
