...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for widget in orm.Content.objects.filter(type='widget'):
            content = json.loads(widget.content)
            if content['widget'] == 'articles':
                content['title'] = 'Siste nyheter'
                content['tags'] = []
                content['tag_link'] = None
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 27, 16, 14, 48, 876768)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 27, 16, 14, 48, 876612)'}),
