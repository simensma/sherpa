...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Version.new_owner'
        db.alter_column(u'page_version', 'new_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['user.User']))

        # Changing field 'Variant.new_owner'
        db.alter_column(u'page_variant', 'new_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['user.User']))

        # Changing field 'Page.new_created_by'
        db.alter_column(u'page_page', 'new_created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['user.User']))

    def backwards(self, orm):

        # Changing field 'Version.new_owner'
        db.alter_column(u'page_version', 'new_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['user.User']))

        # Changing field 'Variant.new_owner'
        db.alter_column(u'page_variant', 'new_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['user.User']))

        # Changing field 'Page.new_created_by'
        db.alter_column(u'page_page', 'new_created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['user.User']))
