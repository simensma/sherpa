...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for page in orm['page.Page'].objects.all():
            page.created_by = page.publisher
            page.created_date = page.created
            page.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 15, 55, 52, 831088)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 15, 55, 52, 830931)'}),
