...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('page_page', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pages_created', to=orm['user.Profile']), keep_default=False)

        # Adding field 'Page.created_date'
        db.add_column('page_page', 'created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 1, 10, 15, 52, 16, 582840), blank=True), keep_default=False)

        # Adding field 'Page.modified_by'
        db.add_column('page_page', 'modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pages_modified', null=True, to=orm['user.Profile']), keep_default=False)

        # Adding field 'Page.modified_date'
        db.add_column('page_page', 'modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.created_by'
        db.delete_column('page_page', 'created_by_id')

        # Deleting field 'Page.created_date'
        db.delete_column('page_page', 'created_date')

        # Deleting field 'Page.modified_by'
        db.delete_column('page_page', 'modified_by_id')

        # Deleting field 'Page.modified_date'
        db.delete_column('page_page', 'modified_date')
    ...
    models = {
        ...
        'articles.article': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'articles_created'", 'to': "orm['user.Profile']"}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'hide_thumbnail': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'articles_modified'", 'null': 'True', 'to': "orm['user.Profile']"}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 15, 52, 16, 609507)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 15, 52, 16, 609355)'}),
        ...
        'page.page': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pages_created'", 'to': "orm['user.Profile']"}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pages_modified'", 'null': 'True', 'to': "orm['user.Profile']"}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['page.Page']", 'null': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'page.version': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'versions'", 'symmetrical': 'False', 'to': "orm['core.Tag']"}),
