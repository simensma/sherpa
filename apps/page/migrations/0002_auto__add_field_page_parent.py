...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('page_page', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['page.Page'], null=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 2, 12, 14, 41, 184013)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 2, 12, 14, 41, 183859)'}),
