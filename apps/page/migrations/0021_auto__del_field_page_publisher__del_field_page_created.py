...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('page_page', 'created')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Page.publisher'
        raise RuntimeError("Cannot reverse this migration. 'Page.publisher' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Page.created'
        raise RuntimeError("Cannot reverse this migration. 'Page.created' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 16, 2, 21, 902079)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 16, 2, 21, 901904)'}),
