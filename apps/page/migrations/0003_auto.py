...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('page_version_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('version', models.ForeignKey(orm['page.version'], null=False)),
            ('tag', models.ForeignKey(orm['admin.tag'], null=False))
        ))
        db.create_unique('page_version_tags', ['version_id', 'tag_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field tags on 'Version'
        db.delete_table('page_version_tags')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 27, 15, 39, 32, 606682)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 27, 15, 39, 32, 606450)'}),
