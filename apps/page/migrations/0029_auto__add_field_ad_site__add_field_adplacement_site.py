...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.site'
        db.add_column(u'page_ad', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Site']),
                      keep_default=False)

        # Adding field 'AdPlacement.site'
        db.add_column(u'page_adplacement', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ad.site'
        db.delete_column(u'page_ad', 'site_id')

        # Deleting field 'AdPlacement.site'
        db.delete_column(u'page_adplacement', 'site_id')
