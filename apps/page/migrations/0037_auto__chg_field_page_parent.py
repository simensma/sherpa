...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'page_page', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['page.Page'], null=True))

    def backwards(self, orm):

        # Changing field 'Page.parent'
        db.alter_column(u'page_page', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['page.Page'], null=True))
