...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variant.name'
        db.alter_column(u'page_variant', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Page.title'
        db.alter_column(u'page_page', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Page.slug'
        db.alter_column(u'page_page', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Variant.name'
        db.alter_column(u'page_variant', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Page.title'
        db.alter_column(u'page_page', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Page.slug'
        db.alter_column(u'page_page', 'slug', self.gf('django.db.models.fields.CharField')(max_length=50))
