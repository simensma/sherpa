...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdPlacement.view_limit'
        db.add_column('page_adplacement', 'view_limit', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Changing field 'AdPlacement.end_date'
        db.alter_column('page_adplacement', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'AdPlacement.start_date'
        db.alter_column('page_adplacement', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'AdPlacement.view_limit'
        db.delete_column('page_adplacement', 'view_limit')

        # Changing field 'AdPlacement.end_date'
        db.alter_column('page_adplacement', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 9, 12)))

        # Changing field 'AdPlacement.start_date'
        db.alter_column('page_adplacement', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 9, 12)))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 15, 24, 52, 605943)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 15, 24, 52, 605780)'}),
