...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'page_page', 'pub_date')


    def backwards(self, orm):
        # Adding field 'Page.pub_date'
        db.add_column(u'page_page', 'pub_date',
    ...
    models = {
        ...
        u'page.column': {
            ...
            'row': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'columns'", 'to': u"orm['page.Row']"}),
            'span': ('django.db.models.fields.IntegerField', [], {})
        },
        u'page.content': {
            'Meta': {'object_name': 'Content'},
            'column': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contents'", 'to': u"orm['page.Column']"}),
        ...
        u'page.page': {
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'to': u"orm['page.Page']", 'null': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
