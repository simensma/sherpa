...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('page_page', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=site.id, to=orm['core.Site']), keep_default=False)

        # Adding field 'Menu.site'
        db.add_column('page_menu', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=site.id, to=orm['core.Site']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.site'
        db.delete_column('page_page', 'site_id')

        # Deleting field 'Menu.site'
        db.delete_column('page_menu', 'site_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 6, 10, 22, 58, 748109)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 6, 10, 22, 58, 747937)'}),
