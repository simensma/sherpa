...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'page_page', u'lft')

        # Deleting field 'Page.rght'
        db.delete_column(u'page_page', u'rght')

        # Deleting field 'Page.tree_id'
        db.delete_column(u'page_page', u'tree_id')

        # Deleting field 'Page.level'
        db.delete_column(u'page_page', u'level')
