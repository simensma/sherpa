...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for site in orm['core.Site'].objects.all():
            frontpage = orm['page.Page'].objects.get(site=site, slug='')
            for page in orm['page.Page'].objects.filter(site=site, parent=None).exclude(slug=''):
                page.parent = frontpage
                page.save()
