...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AdPlacement.placement'
        db.delete_column('page_adplacement', 'placement')


    def backwards(self, orm):
        
        # Adding field 'AdPlacement.placement'
        db.add_column('page_adplacement', 'placement', self.gf('django.db.models.fields.CharField')(default='core_frontpage', max_length=100), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 14, 30, 55, 577090)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 14, 30, 55, 576919)'}),
