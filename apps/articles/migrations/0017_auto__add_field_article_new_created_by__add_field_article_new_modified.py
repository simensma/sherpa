...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.new_created_by'
        db.add_column(u'articles_article', 'new_created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_articles_created', null=True, to=orm['user.User']),
                      keep_default=False)

        # Adding field 'Article.new_modified_by'
        db.add_column(u'articles_article', 'new_modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_articles_modified', null=True, to=orm['user.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.new_created_by'
        db.delete_column(u'articles_article', 'new_created_by_id')

        # Deleting field 'Article.new_modified_by'
        db.delete_column(u'articles_article', 'new_modified_by_id')
