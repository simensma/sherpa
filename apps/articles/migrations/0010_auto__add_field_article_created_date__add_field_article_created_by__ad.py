...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articles_article', 'created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 1, 10, 11, 52, 58, 118593), blank=True), keep_default=False)

        # Adding field 'Article.created_by'
        db.add_column('articles_article', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='articles_created', to=orm['user.Profile']), keep_default=False)

        # Adding field 'Article.modified_date'
        db.add_column('articles_article', 'modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 1, 10, 11, 53, 8, 854899), blank=True), keep_default=False)

        # Adding field 'Article.modified_by'
        db.add_column('articles_article', 'modified_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='articles_modified', to=orm['user.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.created_date'
        db.delete_column('articles_article', 'created_date')

        # Deleting field 'Article.created_by'
        db.delete_column('articles_article', 'created_by_id')

        # Deleting field 'Article.modified_date'
        db.delete_column('articles_article', 'modified_date')

        # Deleting field 'Article.modified_by'
        db.delete_column('articles_article', 'modified_by_id')
    ...
    models = {
        'articles.article': {
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'articles_modified'", 'to': "orm['user.Profile']"}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 11, 53, 14, 417106)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 11, 53, 14, 416837)'}),
