...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for article in orm['articles.Article'].objects.all():
            article.created_date = article.created
            article.modified_date = article.created
            article.created_by = article.variant_set.all()[0].version_set.all()[0].owner
            article.modified_by = article.variant_set.all()[0].version_set.all()[0].owner
            article.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 13, 4, 24, 137637)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 13, 4, 24, 137469)'}),
