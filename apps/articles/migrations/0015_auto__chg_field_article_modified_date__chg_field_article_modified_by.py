...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('articles_article', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['user.Profile']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Article.modified_date'
        raise RuntimeError("Cannot reverse this migration. 'Article.modified_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Article.modified_by'
        raise RuntimeError("Cannot reverse this migration. 'Article.modified_by' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 13, 34, 8, 808665)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 13, 34, 8, 808427)'}),
