...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'articles_article', 'thumbnail', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

    def backwards(self, orm):

        # Changing field 'Article.thumbnail'
        db.alter_column(u'articles_article', 'thumbnail', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        u'articles.article': {
            ...
            'thumbnail': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True'})
        },
