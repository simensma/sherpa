...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for article in orm['articles.Article'].objects.all():
            article.modified_date = article.created_date
            article.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 13, 26, 33, 660769)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 13, 26, 33, 660612)'}),
