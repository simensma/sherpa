...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        redirects = [
            ('gullgjest', '/hyttesamler/'),
            ('gratis-overnatting', '/ung/gratis-overnatting/'),
            ('E1', '/e1/'),
            ('fjelltreff', '/fjelltreffen/'),
            ('merkehandboka', 'http://www.merkehandboka.no/'),
            ('nasjonalt-skiltprosjekt', 'http://www.turskiltprosjektet.no/'),
            ('turplanlegger', 'http://ut.no/'),
        ]
