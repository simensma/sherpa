...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ZipcodeState'
        db.create_table('core_zipcodestate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_update', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('core', ['ZipcodeState'])

        # "Magic" date; this was approximately when the last manual zipcode update occured.
        state = orm['core.ZipcodeState'](last_update=datetime.datetime(day=26, month=11, year=2012))
        state.save()


    def backwards(self, orm):
        
        # Deleting model 'ZipcodeState'
        db.delete_table('core_zipcodestate')
