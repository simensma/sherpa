...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for s in orm['core.Site'].objects.all():
            s.forening = s.original_forening
            s.save()
    ...
    models = {
        ...
        u'foreninger.forening': {
            ...
            'site': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'original_forening'", 'unique': 'True', 'null': 'True', 'to': u"orm['core.Site']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
