...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Site.template' to match new field type.
        db.rename_column(u'core_site', 'template_id', 'template')
        # Changing field 'Site.template'
        db.alter_column(u'core_site', 'template', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Removing index on 'Site', fields ['template']
        db.delete_index(u'core_site', ['template_id'])


    def backwards(self, orm):
        # Adding index on 'Site', fields ['template']
        db.create_index(u'core_site', ['template_id'])


        # Renaming column for 'Site.template' to match new field type.
        db.rename_column(u'core_site', 'template', 'template_id')
        # Changing field 'Site.template'
        db.alter_column(u'core_site', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SiteTemplate']))
