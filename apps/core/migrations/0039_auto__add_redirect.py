...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_redirect', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='redirects', to=orm['core.Site'])),
        ...
        db.send_create_signal(u'core', ['Redirect'])


    def backwards(self, orm):
        # Deleting model 'Redirect'
        db.delete_table(u'core_redirect')
