...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.foreninger'
        db.add_column(u'core_site', 'forening',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='sites', to=orm['foreninger.Forening']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.forening'
        db.delete_column(u'core_site', 'forening_id')
    ...
    models = {
        ...
        u'core.site': {
            ...
            'foreninger': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sites'", 'to': u"orm['foreninger.Forening']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
