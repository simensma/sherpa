...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'County.area'
        db.add_column(u'core_county', 'area',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'County.perimeter'
        db.add_column(u'core_county', 'perimeter',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'County.geom'
        db.add_column(u'core_county', 'geom',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'County.area'
        db.delete_column(u'core_county', 'area')

        # Deleting field 'County.perimeter'
        db.delete_column(u'core_county', 'perimeter')

        # Deleting field 'County.geom'
        db.delete_column(u'core_county', 'geom')
