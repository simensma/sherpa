...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        site = orm['sites.Site'].objects.get(domain='www.turistforeningen.no')
        new_site = orm['core.Site'](domain=site.domain, template=site.details.template, prefix=site.details.prefix)
        new_site.save()
        site.delete()

    def backwards(self, orm):
        pass # Not going to bother with backwards migrations anymore, who ever needs them anyway :)
