...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteDetails.prefix'
        db.add_column('core_sitedetails', 'prefix', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteDetails.prefix'
        db.delete_column('core_sitedetails', 'prefix')
