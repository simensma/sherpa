...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.template_description'
        db.add_column(u'core_site', 'template_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1023),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.template_description'
        db.delete_column(u'core_site', 'template_description')
    ...
    models = {
        ...
        u'core.site': {
            ...
            'template_description': ('django.db.models.fields.CharField', [], {'max_length': '1023'}),
