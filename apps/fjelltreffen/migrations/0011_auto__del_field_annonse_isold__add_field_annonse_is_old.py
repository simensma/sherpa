...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annonse.isold'
        db.delete_column('fjelltreffen_annonse', 'isold')

        # Adding field 'Annonse.is_old'
        db.add_column('fjelltreffen_annonse', 'is_old',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Annonse.isold'
        db.add_column('fjelltreffen_annonse', 'isold',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Annonse.is_old'
        db.delete_column('fjelltreffen_annonse', 'is_old')
    ...
    models = {
        ...
        'fjelltreffen.annonse': {
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fjelltreffen_annonser'", 'to': "orm['user.Profile']"}),
