...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annonse.fylke'
        db.delete_column('fjelltreffen_annonse', 'fylke_id')

        # Adding field 'Annonse.county'
        db.add_column('fjelltreffen_annonse', 'county',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=45, to=orm['core.County']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Annonse.fylke'
        raise RuntimeError("Cannot reverse this migration. 'Annonse.fylke' and its values cannot be restored.")
        # Deleting field 'Annonse.county'
        db.delete_column('fjelltreffen_annonse', 'county_id')
