...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annonse.date'
        db.delete_column('fjelltreffen_annonse', 'date')

        # Adding field 'Annonse.date_added'
        db.add_column('fjelltreffen_annonse', 'date_added',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 2, 11, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Annonse.date_renewed'
        db.add_column('fjelltreffen_annonse', 'date_renewed',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 2, 11, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Annonse.date'
        raise RuntimeError("Cannot reverse this migration. 'Annonse.date' and its values cannot be restored.")
        # Deleting field 'Annonse.date_added'
        db.delete_column('fjelltreffen_annonse', 'date_added')

        # Deleting field 'Annonse.date_renewed'
        db.delete_column('fjelltreffen_annonse', 'date_renewed')
    ...
    models = {
        ...
        'fjelltreffen.annonse': {
            ...
            'county': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.County']"}),
