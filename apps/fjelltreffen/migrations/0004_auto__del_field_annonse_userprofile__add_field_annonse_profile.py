...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Annonse.userprofile'
        db.delete_column('fjelltreffen_annonse', 'userprofile_id')

        # Adding field 'Annonse.profile'
        db.add_column('fjelltreffen_annonse', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['user.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Annonse.userprofile'
        raise RuntimeError("Cannot reverse this migration. 'Annonse.userprofile' and its values cannot be restored.")

        # Deleting field 'Annonse.profile'
        db.delete_column('fjelltreffen_annonse', 'profile_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 13, 32, 10, 860152)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 13, 32, 10, 859992)'}),
