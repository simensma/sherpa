...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Annonse.gender'
        db.delete_column('fjelltreffen_annonse', 'gender')


    def backwards(self, orm):
        
        # Adding field 'Annonse.gender'
        db.add_column('fjelltreffen_annonse', 'gender', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 13, 25, 28, 666076)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 13, 25, 28, 665731)'}),
