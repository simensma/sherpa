...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annonse.user'
        db.alter_column(u'fjelltreffen_annonse', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['user.User']))

    def backwards(self, orm):

        # Changing field 'Annonse.user'
        db.alter_column(u'fjelltreffen_annonse', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['user.User']))
