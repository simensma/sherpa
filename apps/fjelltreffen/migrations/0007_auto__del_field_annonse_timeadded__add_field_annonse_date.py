...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annonse.timeadded'
        db.delete_column('fjelltreffen_annonse', 'timeadded')

        # Adding field 'Annonse.date'
        db.add_column('fjelltreffen_annonse', 'date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 1, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Annonse.timeadded'
        raise RuntimeError("Cannot reverse this migration. 'Annonse.timeadded' and its values cannot be restored.")
