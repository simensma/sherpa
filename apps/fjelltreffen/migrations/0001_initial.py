...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Annonse'
        db.create_table('fjelltreffen_annonse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('userprofile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.Profile'])),
            ('timeadded', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('fylke', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.County'])),
            ('image', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('hidden', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('hideage', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('age', self.gf('django.db.models.fields.IntegerField')()),
            ('gender', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('isold', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('fjelltreffen', ['Annonse'])


    def backwards(self, orm):
        
        # Deleting model 'Annonse'
        db.delete_table('fjelltreffen_annonse')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 15, 14, 3, 54, 764644)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 15, 14, 3, 54, 764456)'}),
        ...
        'fjelltreffen.annonse': {
            ...
            'fylke': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.County']"}),
            ...
            'isold': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'timeadded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'userprofile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user.Profile']"})
        },
