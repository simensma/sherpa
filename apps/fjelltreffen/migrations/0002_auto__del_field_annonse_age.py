...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Annonse.age'
        db.delete_column('fjelltreffen_annonse', 'age')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Annonse.age'
        raise RuntimeError("Cannot reverse this migration. 'Annonse.age' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 15, 14, 34, 11, 487472)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 15, 14, 34, 11, 487316)'}),
