...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annonse.is_image_old'
        db.add_column('fjelltreffen_annonse', 'is_image_old',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annonse.is_image_old'
        db.delete_column('fjelltreffen_annonse', 'is_image_old')
