...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annonse.county'
        db.alter_column('fjelltreffen_annonse', 'county_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.County'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Annonse.county'
        raise RuntimeError("Cannot reverse this migration. 'Annonse.county' and its values cannot be restored.")
