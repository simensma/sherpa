...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'fjelltreffen_annonse', 'profile_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Annonse.profile'
        raise RuntimeError("Cannot reverse this migration. 'Annonse.profile' and its values cannot be restored.")
