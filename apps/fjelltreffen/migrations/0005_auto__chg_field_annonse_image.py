...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annonse.image'
        db.alter_column('fjelltreffen_annonse', 'image', self.gf('django.db.models.fields.CharField')(default='', max_length=2048))


    def backwards(self, orm):
        
        # Changing field 'Annonse.image'
        db.alter_column('fjelltreffen_annonse', 'image', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 18, 27, 26, 644429)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 18, 27, 26, 644147)'}),
