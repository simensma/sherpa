...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annonse.image_thumb'
        db.add_column('fjelltreffen_annonse', 'image_thumb',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annonse.image_thumb'
        db.delete_column('fjelltreffen_annonse', 'image_thumb')
