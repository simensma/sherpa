...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annonse.user'
        db.add_column(u'fjelltreffen_annonse', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_fjelltreffen_annonser', null=True, to=orm['user.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annonse.user'
        db.delete_column(u'fjelltreffen_annonse', 'user_id')
