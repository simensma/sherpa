...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.forening_cabin'
        db.add_column(u'aktiviteter_aktivitet', 'forening_cabin',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['aktiviteter.Cabin']),
                      keep_default=False)

        # Adding M2M table for field co_foreninger_cabin on 'Aktivitet'
        db.create_table(u'aktiviteter_aktivitet_co_foreninger_cabin', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('aktivitet', models.ForeignKey(orm[u'aktiviteter.aktivitet'], null=False)),
            ('cabin', models.ForeignKey(orm[u'aktiviteter.cabin'], null=False))
        ))
        db.create_unique(u'aktiviteter_aktivitet_co_foreninger_cabin', ['aktivitet_id', 'cabin_id'])


        # Changing field 'Aktivitet.forening'
        db.alter_column(u'aktiviteter_aktivitet', 'forening_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['foreninger.Forening']))

    def backwards(self, orm):
        # Deleting field 'Aktivitet.forening_cabin'
        db.delete_column(u'aktiviteter_aktivitet', 'forening_cabin_id')

        # Removing M2M table for field co_foreninger_cabin on 'Aktivitet'
        db.delete_table('aktiviteter_aktivitet_co_foreninger_cabin')


        # User chose to not deal with backwards NULL issues for 'Aktivitet.forening'
        raise RuntimeError("Cannot reverse this migration. 'Aktivitet.forening' and its values cannot be restored.")
