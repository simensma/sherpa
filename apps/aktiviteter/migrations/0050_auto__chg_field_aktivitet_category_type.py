...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aktivitet.category_type'
        db.alter_column(u'aktiviteter_aktivitet', 'category_type', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Aktivitet.category_type'
        db.alter_column(u'aktiviteter_aktivitet', 'category_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
