...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConversionFailure.latest_date'
        db.add_column(u'aktiviteter_conversionfailure', 'latest_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConversionFailure.latest_date'
        db.delete_column(u'aktiviteter_conversionfailure', 'latest_date')
