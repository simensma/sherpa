...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.start_point'
        db.add_column('aktiviteter_aktivitet', 'start_point',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitet.start_point'
        db.delete_column('aktiviteter_aktivitet', 'start_point')
