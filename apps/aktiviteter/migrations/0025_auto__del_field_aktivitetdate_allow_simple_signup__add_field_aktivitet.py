...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AktivitetDate.allow_simple_signup'
        db.delete_column(u'aktiviteter_aktivitetdate', 'allow_simple_signup')

        # Adding field 'AktivitetDate.signup_simple_allowed'
        db.add_column(u'aktiviteter_aktivitetdate', 'signup_simple_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AktivitetDate.allow_simple_signup'
        db.add_column(u'aktiviteter_aktivitetdate', 'allow_simple_signup',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AktivitetDate.signup_simple_allowed'
        db.delete_column(u'aktiviteter_aktivitetdate', 'signup_simple_allowed')
