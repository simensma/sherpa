...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SynchronizationDate'
        db.create_table(u'aktiviteter_synchronizationdate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'aktiviteter', ['SynchronizationDate'])


    def backwards(self, orm):
        # Deleting model 'SynchronizationDate'
        db.delete_table(u'aktiviteter_synchronizationdate')
