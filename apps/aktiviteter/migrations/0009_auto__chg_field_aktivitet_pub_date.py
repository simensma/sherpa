...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aktivitet.pub_date'
        db.alter_column('aktiviteter_aktivitet', 'pub_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Aktivitet.pub_date'
        db.alter_column('aktiviteter_aktivitet', 'pub_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
