...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AktivitetImage'
        db.create_table('aktiviteter_aktivitetimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('aktivitet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['aktiviteter.Aktivitet'])),
            ...
            ('photographer', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('aktiviteter', ['AktivitetImage'])


    def backwards(self, orm):
        # Deleting model 'AktivitetImage'
        db.delete_table('aktiviteter_aktivitetimage')
    ...
    models = {
        ...
        'aktiviteter.aktivitetimage': {
            'Meta': {'object_name': 'AktivitetImage'},
            'aktivitet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': "orm['aktiviteter.Aktivitet']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
