...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AktivitetDate.meeting_time'
        db.add_column(u'aktiviteter_aktivitetdate', 'meeting_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AktivitetDate.meeting_time'
        db.delete_column(u'aktiviteter_aktivitetdate', 'meeting_time')
