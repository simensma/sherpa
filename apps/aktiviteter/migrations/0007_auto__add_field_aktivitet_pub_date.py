...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.pub_date'
        db.add_column('aktiviteter_aktivitet', 'pub_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 4, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitet.pub_date'
        db.delete_column('aktiviteter_aktivitet', 'pub_date')
