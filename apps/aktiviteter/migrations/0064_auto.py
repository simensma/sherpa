...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field audiences on 'Aktivitet'
        db.create_table(u'aktiviteter_aktivitet_audiences', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('aktivitet', models.ForeignKey(orm[u'aktiviteter.aktivitet'], null=False)),
            ('aktivitetaudience', models.ForeignKey(orm[u'aktiviteter.aktivitetaudience'], null=False))
        ))
        db.create_unique(u'aktiviteter_aktivitet_audiences', ['aktivitet_id', 'aktivitetaudience_id'])


    def backwards(self, orm):
        # Removing M2M table for field audiences on 'Aktivitet'
        db.delete_table('aktiviteter_aktivitet_audiences')
