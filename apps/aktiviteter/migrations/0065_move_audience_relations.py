...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        audiences = {
            'adults': orm['aktiviteter.AktivitetAudience'].objects.get(name='adults'),
            'children': orm['aktiviteter.AktivitetAudience'].objects.get(name='children'),
            'youth': orm['aktiviteter.AktivitetAudience'].objects.get(name='youth'),
            'senior': orm['aktiviteter.AktivitetAudience'].objects.get(name='senior'),
            'mountaineers': orm['aktiviteter.AktivitetAudience'].objects.get(name='mountaineers'),
            'disabled': orm['aktiviteter.AktivitetAudience'].objects.get(name='disabled'),
        }
        for aktivitet in orm['aktiviteter.Aktivitet'].objects.only('audiences_tmp'):
            old_audiences = json.loads(aktivitet.audiences_tmp)
            new_audiences = [audiences[audience] for audience in old_audiences]
            aktivitet.audiences = new_audiences
    ...
    models = {
        u'aktiviteter.aktivitet': {
            ...
            'audiences': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'aktiviteter'", 'symmetrical': 'False', 'to': u"orm['aktiviteter.AktivitetAudience']"}),
            'audiences_tmp': ('django.db.models.fields.CharField', [], {'max_length': '1023'}),
            ...
            'category_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
        ...
        u'aktiviteter.aktivitetaudience': {
            'Meta': {'object_name': 'AktivitetAudience'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'aktiviteter.aktivitetdate': {
            ...
            'cancel_deadline': ('django.db.models.fields.DateField', [], {'null': 'True'}),
        ...
        u'aktiviteter.aktivitetimage': {
            'Meta': {'ordering': "['order']", 'object_name': 'AktivitetImage'},
        ...
        u'aktiviteter.conversionfailure': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'aktiviteter.synchronizationdate': {
            'Meta': {'object_name': 'SynchronizationDate'},
