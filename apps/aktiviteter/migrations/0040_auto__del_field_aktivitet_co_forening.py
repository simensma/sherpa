...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Aktivitet.co_forening'
        db.delete_column(u'aktiviteter_aktivitet', 'co_forening_id')

        # Adding M2M table for field co_foreninger on 'Aktivitet'
        db.create_table(u'aktiviteter_aktivitet_co_foreninger', (
        ...
        db.create_unique(u'aktiviteter_aktivitet_co_foreninger', ['aktivitet_id', 'forening_id'])


    def backwards(self, orm):
        # Adding field 'Aktivitet.co_forening'
        db.add_column(u'aktiviteter_aktivitet', 'co_forening',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['foreninger.Forening']),
                      keep_default=False)

        # Removing M2M table for field co_foreninger on 'Aktivitet'
        db.delete_table('aktiviteter_aktivitet_co_foreninger')
