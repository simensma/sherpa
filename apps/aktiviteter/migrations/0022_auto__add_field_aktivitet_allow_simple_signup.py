...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field turledere on 'AktivitetDate'
        db.create_table(u'aktiviteter_aktivitetdate_turledere', (
        ...
        db.create_unique(u'aktiviteter_aktivitetdate_turledere', ['aktivitetdate_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        db.create_unique(u'aktiviteter_aktivitetdate_leaders', ['aktivitetdate_id', 'user_id'])

        # Removing M2M table for field turledere on 'AktivitetDate'
        db.delete_table('aktiviteter_aktivitetdate_turledere')
