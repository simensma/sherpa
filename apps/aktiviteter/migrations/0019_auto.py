...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field new_leaders on 'AktivitetDate'
        db.create_table(u'aktiviteter_aktivitetdate_new_leaders', (
        ...
        db.create_unique(u'aktiviteter_aktivitetdate_new_leaders', ['aktivitetdate_id', 'user_id'])

        # Adding M2M table for field new_participants on 'AktivitetDate'
        db.create_table(u'aktiviteter_aktivitetdate_new_participants', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('aktivitetdate', models.ForeignKey(orm[u'aktiviteter.aktivitetdate'], null=False)),
            ('user', models.ForeignKey(orm[u'user.user'], null=False))
        ))
        db.create_unique(u'aktiviteter_aktivitetdate_new_participants', ['aktivitetdate_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field new_leaders on 'AktivitetDate'
        db.delete_table('aktiviteter_aktivitetdate_new_leaders')

        # Removing M2M table for field new_participants on 'AktivitetDate'
        db.delete_table('aktiviteter_aktivitetdate_new_participants')
