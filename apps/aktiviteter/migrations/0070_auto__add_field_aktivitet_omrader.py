...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.omrader'
        db.add_column(u'aktiviteter_aktivitet', 'omrader',
                      self.gf('djorm_pgarray.fields.TextArrayField')(default=None, dbtype=u'text', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitet.omrader'
        db.delete_column(u'aktiviteter_aktivitet', 'omrader')
    ...
    models = {
        u'aktiviteter.aktivitet': {
            ...
            'omrader': ('djorm_pgarray.fields.TextArrayField', [], {'default': 'None', u'dbtype': "u'text'", 'blank': 'True'}),
        ...
        u'aktiviteter.aktivitetdate': {
            ...
            'signup_montis': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
