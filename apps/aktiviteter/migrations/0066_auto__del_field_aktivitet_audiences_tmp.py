...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Aktivitet.audiences_tmp'
        db.delete_column(u'aktiviteter_aktivitet', 'audiences_tmp')


    def backwards(self, orm):
        # Adding field 'Aktivitet.audiences_tmp'
        db.add_column(u'aktiviteter_aktivitet', 'audiences_tmp',
