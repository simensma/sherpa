...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ImportFailure'
        db.delete_table(u'aktiviteter_importfailure')

        # Removing M2M table for field foreninger on 'ImportFailure'
        db.delete_table('aktiviteter_importfailure_foreninger')

        # Adding model 'ConversionFailure'
        db.create_table(u'aktiviteter_conversionfailure', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sherpa2_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'aktiviteter', ['ConversionFailure'])

        # Adding M2M table for field foreninger on 'ConversionFailure'
        db.create_table(u'aktiviteter_conversionfailure_foreninger', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('conversionfailure', models.ForeignKey(orm[u'aktiviteter.conversionfailure'], null=False)),
            ('forening', models.ForeignKey(orm[u'foreninger.forening'], null=False))
        ))
        db.create_unique(u'aktiviteter_conversionfailure_foreninger', ['conversionfailure_id', 'forening_id'])


    def backwards(self, orm):
        # Adding model 'ImportFailure'
        db.create_table(u'aktiviteter_importfailure', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('sherpa2_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=255)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'aktiviteter', ['ImportFailure'])

        # Adding M2M table for field foreninger on 'ImportFailure'
        db.create_table(u'aktiviteter_importfailure_foreninger', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('importfailure', models.ForeignKey(orm[u'aktiviteter.importfailure'], null=False)),
            ('forening', models.ForeignKey(orm[u'foreninger.forening'], null=False))
        ))
        db.create_unique(u'aktiviteter_importfailure_foreninger', ['importfailure_id', 'forening_id'])

        # Deleting model 'ConversionFailure'
        db.delete_table(u'aktiviteter_conversionfailure')

        # Removing M2M table for field foreninger on 'ConversionFailure'
        db.delete_table('aktiviteter_conversionfailure_foreninger')
