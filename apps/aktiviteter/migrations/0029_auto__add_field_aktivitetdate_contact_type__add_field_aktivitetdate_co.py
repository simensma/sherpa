...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AktivitetDate.contact_type'
        db.add_column(u'aktiviteter_aktivitetdate', 'contact_type',
                      self.gf('django.db.models.fields.CharField')(default=u'arrang\xf8r', max_length=255),
                      keep_default=False)

        # Adding field 'AktivitetDate.contact_custom_name'
        db.add_column(u'aktiviteter_aktivitetdate', 'contact_custom_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'AktivitetDate.contact_custom_phone'
        db.add_column(u'aktiviteter_aktivitetdate', 'contact_custom_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'AktivitetDate.contact_custom_email'
        db.add_column(u'aktiviteter_aktivitetdate', 'contact_custom_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AktivitetDate.contact_type'
        db.delete_column(u'aktiviteter_aktivitetdate', 'contact_type')

        # Deleting field 'AktivitetDate.contact_custom_name'
        db.delete_column(u'aktiviteter_aktivitetdate', 'contact_custom_name')

        # Deleting field 'AktivitetDate.contact_custom_phone'
        db.delete_column(u'aktiviteter_aktivitetdate', 'contact_custom_phone')

        # Deleting field 'AktivitetDate.contact_custom_email'
        db.delete_column(u'aktiviteter_aktivitetdate', 'contact_custom_email')
