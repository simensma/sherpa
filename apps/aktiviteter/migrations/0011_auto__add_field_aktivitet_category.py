...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.category'
        db.add_column('aktiviteter_aktivitet', 'category',
                      self.gf('django.db.models.fields.CharField')(default='trip', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitet.category'
        db.delete_column('aktiviteter_aktivitet', 'category')
