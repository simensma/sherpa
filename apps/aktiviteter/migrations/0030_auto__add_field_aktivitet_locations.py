...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.locations'
        db.add_column(u'aktiviteter_aktivitet', 'locations',
                      self.gf('django.db.models.fields.CharField')(default='[]', max_length=4091),
                      keep_default=False)

        # Adding M2M table for field counties on 'Aktivitet'
        db.create_table(u'aktiviteter_aktivitet_counties', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('aktivitet', models.ForeignKey(orm[u'aktiviteter.aktivitet'], null=False)),
            ('county', models.ForeignKey(orm[u'core.county'], null=False))
        ))
        db.create_unique(u'aktiviteter_aktivitet_counties', ['aktivitet_id', 'county_id'])

        # Adding M2M table for field municipalities on 'Aktivitet'
        db.create_table(u'aktiviteter_aktivitet_municipalities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('aktivitet', models.ForeignKey(orm[u'aktiviteter.aktivitet'], null=False)),
            ('municipality', models.ForeignKey(orm[u'core.municipality'], null=False))
        ))
        db.create_unique(u'aktiviteter_aktivitet_municipalities', ['aktivitet_id', 'municipality_id'])


    def backwards(self, orm):
        # Deleting field 'Aktivitet.locations'
        db.delete_column(u'aktiviteter_aktivitet', 'locations')

        # Removing M2M table for field counties on 'Aktivitet'
        db.delete_table('aktiviteter_aktivitet_counties')

        # Removing M2M table for field municipalities on 'Aktivitet'
        db.delete_table('aktiviteter_aktivitet_municipalities')
