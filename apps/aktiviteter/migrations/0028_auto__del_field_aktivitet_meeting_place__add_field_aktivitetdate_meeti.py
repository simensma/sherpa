...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Aktivitet.meeting_place'
        db.delete_column(u'aktiviteter_aktivitet', 'meeting_place')

        # Adding field 'AktivitetDate.meeting_place'
        db.add_column(u'aktiviteter_aktivitetdate', 'meeting_place',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Aktivitet.meeting_place'
        raise RuntimeError("Cannot reverse this migration. 'Aktivitet.meeting_place' and its values cannot be restored.")
        # Deleting field 'AktivitetDate.meeting_place'
        db.delete_column(u'aktiviteter_aktivitetdate', 'meeting_place')
