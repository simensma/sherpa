...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Aktivitet.category_sub'
        db.delete_column(u'aktiviteter_aktivitet', 'category_sub')

        # Adding field 'Aktivitet.category_type'
        db.add_column(u'aktiviteter_aktivitet', 'category_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Aktivitet.category_sub'
        db.add_column(u'aktiviteter_aktivitet', 'category_sub',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'Aktivitet.category_type'
        db.delete_column(u'aktiviteter_aktivitet', 'category_type')
