...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AktivitetDate.signup_cancel_deadline'
        db.delete_column(u'aktiviteter_aktivitetdate', 'signup_cancel_deadline')


    def backwards(self, orm):
        # Adding field 'AktivitetDate.signup_cancel_deadline'
        db.add_column(u'aktiviteter_aktivitetdate', 'signup_cancel_deadline',
