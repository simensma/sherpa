...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Aktivitet.audience'
        db.delete_column('aktiviteter_aktivitet', 'audience')

        # Adding field 'Aktivitet.audiences'
        db.add_column('aktiviteter_aktivitet', 'audiences',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Aktivitet.audience'
        raise RuntimeError("Cannot reverse this migration. 'Aktivitet.audience' and its values cannot be restored.")
        # Deleting field 'Aktivitet.audiences'
        db.delete_column('aktiviteter_aktivitet', 'audiences')
    ...
    models = {
        ...
        'aktiviteter.aktivitetdate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leaders': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'+'", 'symmetrical': 'False', 'to': "orm['user.Profile']"}),
