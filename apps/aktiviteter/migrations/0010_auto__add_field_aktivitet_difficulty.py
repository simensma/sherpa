...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.difficulty'
        db.add_column('aktiviteter_aktivitet', 'difficulty',
                      self.gf('django.db.models.fields.CharField')(default='easy', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitet.difficulty'
        db.delete_column('aktiviteter_aktivitet', 'difficulty')
