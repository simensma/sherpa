...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AktivitetDate.should_have_turleder'
        db.add_column(u'aktiviteter_aktivitetdate', 'should_have_turleder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AktivitetDate.should_have_turleder'
        db.delete_column(u'aktiviteter_aktivitetdate', 'should_have_turleder')
