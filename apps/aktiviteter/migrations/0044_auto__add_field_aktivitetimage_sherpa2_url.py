...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AktivitetImage.sherpa2_url'
        db.add_column(u'aktiviteter_aktivitetimage', 'sherpa2_url',
                      self.gf('django.db.models.fields.CharField')(max_length=1023, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AktivitetImage.sherpa2_url'
        db.delete_column(u'aktiviteter_aktivitetimage', 'sherpa2_url')
