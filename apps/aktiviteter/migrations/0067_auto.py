...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'AktivitetDate', fields ['start_date']
        db.create_index(u'aktiviteter_aktivitetdate', ['start_date'])


    def backwards(self, orm):
        # Removing index on 'AktivitetDate', fields ['start_date']
        db.delete_index(u'aktiviteter_aktivitetdate', ['start_date'])
