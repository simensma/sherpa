...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AktivitetDate.signup_max_allowed'
        db.alter_column(u'aktiviteter_aktivitetdate', 'signup_max_allowed', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'AktivitetDate.signup_max_allowed'
        db.alter_column(u'aktiviteter_aktivitetdate', 'signup_max_allowed', self.gf('django.db.models.fields.PositiveIntegerField')())
