...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AktivitetDate.signup_start'
        db.alter_column(u'aktiviteter_aktivitetdate', 'signup_start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'AktivitetDate.signup_deadline'
        db.alter_column(u'aktiviteter_aktivitetdate', 'signup_deadline', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'AktivitetDate.signup_cancel_deadline'
        db.alter_column(u'aktiviteter_aktivitetdate', 'signup_cancel_deadline', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AktivitetDate.signup_start'
        raise RuntimeError("Cannot reverse this migration. 'AktivitetDate.signup_start' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AktivitetDate.signup_deadline'
        raise RuntimeError("Cannot reverse this migration. 'AktivitetDate.signup_deadline' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AktivitetDate.signup_cancel_deadline'
        raise RuntimeError("Cannot reverse this migration. 'AktivitetDate.signup_cancel_deadline' and its values cannot be restored.")
