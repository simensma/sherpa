...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.association'
        db.add_column('aktiviteter_aktivitet', 'association',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=56, related_name='+', to=orm['association.Association']),
                      keep_default=False)

        # Adding field 'Aktivitet.co_association'
        db.add_column('aktiviteter_aktivitet', 'co_association',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['association.Association']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitet.association'
        db.delete_column('aktiviteter_aktivitet', 'association_id')

        # Deleting field 'Aktivitet.co_association'
        db.delete_column('aktiviteter_aktivitet', 'co_association_id')


    models = {
        'aktiviteter.aktivitet': {
            'Meta': {'object_name': 'Aktivitet'},
            'association': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['association.Association']"}),
            'audiences': ('django.db.models.fields.CharField', [], {'max_length': '1023'}),
            'category': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'category_tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'aktiviteter'", 'symmetrical': 'False', 'to': "orm['core.Tag']"}),
            'co_association': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['association.Association']"}),
        ...
        'aktiviteter.aktivitetdate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leaders': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'leader_aktivitet_dates'", 'symmetrical': 'False', 'to': "orm['user.Profile']"}),
