...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.turforslag'
        db.add_column(u'aktiviteter_aktivitet', 'turforslag',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitet.turforslag'
        db.delete_column(u'aktiviteter_aktivitet', 'turforslag')
