...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.published'
        db.add_column(u'aktiviteter_aktivitet', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitet.published'
        db.delete_column(u'aktiviteter_aktivitet', 'published')
