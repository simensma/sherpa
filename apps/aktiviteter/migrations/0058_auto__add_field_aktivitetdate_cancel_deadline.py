...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AktivitetDate.cancel_deadline'
        db.add_column(u'aktiviteter_aktivitetdate', 'cancel_deadline',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AktivitetDate.cancel_deadline'
        db.delete_column(u'aktiviteter_aktivitetdate', 'cancel_deadline')
