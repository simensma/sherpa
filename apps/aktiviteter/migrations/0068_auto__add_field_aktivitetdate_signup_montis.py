...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AktivitetDate.signup_montis'
        db.add_column(u'aktiviteter_aktivitetdate', 'signup_montis',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AktivitetDate.signup_montis'
        db.delete_column(u'aktiviteter_aktivitetdate', 'signup_montis')
