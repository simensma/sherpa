...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.sherpa2_id'
        db.add_column(u'aktiviteter_aktivitet', 'sherpa2_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitet.sherpa2_id'
        db.delete_column(u'aktiviteter_aktivitet', 'sherpa2_id')
