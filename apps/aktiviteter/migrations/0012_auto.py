...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field category_tags on 'Aktivitet'
        db.create_table('aktiviteter_aktivitet_category_tags', (
        ...
        db.create_unique('aktiviteter_aktivitet_category_tags', ['aktivitet_id', 'tag_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field category_tags on 'Aktivitet'
        db.delete_table('aktiviteter_aktivitet_category_tags')
