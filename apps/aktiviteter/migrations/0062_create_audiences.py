...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for audience in AktivitetAudience.AUDIENCE_CHOICES:
            a = orm['aktiviteter.AktivitetAudience'](name=audience[0])
            a.save()

    def backwards(self, orm):
        orm['aktiviteter.AktivitetAudience'].objects.all().delete()
