...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitet.getting_there'
        db.add_column(u'aktiviteter_aktivitet', 'getting_there',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Aktivitet.meeting_place'
        db.add_column(u'aktiviteter_aktivitet', 'meeting_place',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitet.getting_there'
        db.delete_column(u'aktiviteter_aktivitet', 'getting_there')
