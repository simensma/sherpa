...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AktivitetAudience'
        db.create_table(u'aktiviteter_aktivitetaudience', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'aktiviteter', ['AktivitetAudience'])


    def backwards(self, orm):
        # Deleting model 'AktivitetAudience'
        db.delete_table(u'aktiviteter_aktivitetaudience')
