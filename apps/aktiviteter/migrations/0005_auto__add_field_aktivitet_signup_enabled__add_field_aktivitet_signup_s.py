...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Aktivitet.signup_start'
        db.add_column('aktiviteter_aktivitet', 'signup_start',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 4, 4, 0, 0)),
                      keep_default=False)

        # Adding field 'Aktivitet.signup_deadline'
        db.add_column('aktiviteter_aktivitet', 'signup_deadline',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 4, 4, 0, 0)),
                      keep_default=False)

        # Adding field 'Aktivitet.signup_cancel_deadline'
        db.add_column('aktiviteter_aktivitet', 'signup_cancel_deadline',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 4, 4, 0, 0)),
                      keep_default=False)
