...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Publication.pub_date'
        db.alter_column('admin_publication', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Publication.pub_date'
        db.alter_column('admin_publication', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
