...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.utm_campaign'
        db.add_column(u'admin_campaign', 'utm_campaign',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.utm_campaign'
        db.delete_column(u'admin_campaign', 'utm_campaign')
