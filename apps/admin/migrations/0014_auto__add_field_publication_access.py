...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.access'
        db.add_column('admin_publication', 'access',
                      self.gf('django.db.models.fields.CharField')(default='all', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Publication.access'
        db.delete_column('admin_publication', 'access')
