...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('admin_imagerecovery', (
        ...
        db.send_create_signal('admin', ['ImageRecovery'])

        # Adding M2M table for field tags on 'ImageRecovery'
        db.create_table('admin_imagerecovery_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('imagerecovery', models.ForeignKey(orm['admin.imagerecovery'], null=False)),
            ('tag', models.ForeignKey(orm['core.tag'], null=False))
        ))
        db.create_unique('admin_imagerecovery_tags', ['imagerecovery_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'ImageRecovery'
        db.delete_table('admin_imagerecovery')
