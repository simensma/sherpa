...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CampaignText'
        db.create_table(u'admin_campaigntext', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(related_name='text', to=orm['admin.Campaign'])),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('style', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal(u'admin', ['CampaignText'])
        ...
        # Adding field 'Campaign.image_crop'
        db.add_column(u'admin_campaign', 'image_crop',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)

        # Adding field 'Campaign.button_enabled'
        db.add_column(u'admin_campaign', 'button_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Campaign.button_label'
        db.add_column(u'admin_campaign', 'button_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)

        # Adding field 'Campaign.button_anchor'
        db.add_column(u'admin_campaign', 'button_anchor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048),
                      keep_default=False)

        # Adding field 'Campaign.button_large'
        db.add_column(u'admin_campaign', 'button_large',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CampaignText'
        db.delete_table(u'admin_campaigntext')

        # Deleting field 'Campaign.image_url'
        db.delete_column(u'admin_campaign', 'image_url')

        # Deleting field 'Campaign.image_crop'
        db.delete_column(u'admin_campaign', 'image_crop')

        # Deleting field 'Campaign.button_enabled'
        db.delete_column(u'admin_campaign', 'button_enabled')

        # Deleting field 'Campaign.button_label'
        db.delete_column(u'admin_campaign', 'button_label')

        # Deleting field 'Campaign.button_anchor'
        db.delete_column(u'admin_campaign', 'button_anchor')

        # Deleting field 'Campaign.button_large'
        db.delete_column(u'admin_campaign', 'button_large')
