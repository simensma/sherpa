...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('admin_publication', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('association', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['association.Association'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1023)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('license', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('admin', ['Publication'])

        # Adding M2M table for field tags on 'Publication'
        db.create_table('admin_publication_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('publication', models.ForeignKey(orm['admin.publication'], null=False)),
            ('tag', models.ForeignKey(orm['core.tag'], null=False))
        ))
        db.create_unique('admin_publication_tags', ['publication_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'Publication'
        db.delete_table('admin_publication')

        # Removing M2M table for field tags on 'Publication'
        db.delete_table('admin_publication_tags')
    ...
    models = {
        ...
        'admin.publication': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1023'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'license': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'publications'", 'symmetrical': 'False', 'to': "orm['core.Tag']"}),
