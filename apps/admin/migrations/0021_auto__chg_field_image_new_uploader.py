...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.new_uploader'
        db.alter_column(u'admin_image', 'new_uploader_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['user.User']))

    def backwards(self, orm):

        # Changing field 'Image.new_uploader'
        db.alter_column(u'admin_image', 'new_uploader_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User'], null=True))
