...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Fotokonkurranse'
        db.create_table(u'admin_fotokonkurranse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admin.Album'], null=True)),
        ))
        db.send_create_signal(u'admin', ['Fotokonkurranse'])
        # Create the initial row
        f = orm['admin.Fotokonkurranse']()
        f.save()


    def backwards(self, orm):
        # Deleting model 'Fotokonkurranse'
        db.delete_table(u'admin_fotokonkurranse')
