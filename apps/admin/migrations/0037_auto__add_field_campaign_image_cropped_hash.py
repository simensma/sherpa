...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.image_cropped_hash'
        db.add_column(u'admin_campaign', 'image_cropped_hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.image_cropped_hash'
        db.delete_column(u'admin_campaign', 'image_cropped_hash')
