...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.ga_event_label'
        db.add_column(u'admin_campaign', 'ga_event_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.ga_event_label'
        db.delete_column(u'admin_campaign', 'ga_event_label')
