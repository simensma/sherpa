...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.created'
        db.alter_column(u'admin_campaign', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Campaign.created'
        db.alter_column(u'admin_campaign', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
