...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        root = orm.Album.objects.get(name='Brukeralbum', parent=None)
        for user_album in orm.Album.objects.filter(parent=root):
            for image in orm.Image.objects.filter(album=user_album):
                image.album = None
                image.save()
            user_album.delete()
        root.delete()
    ...
    def backwards(self, orm):
        print("This migration is irreversible; skipping.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 19, 13, 18, 46, 230680)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 19, 13, 18, 46, 230494)'}),
