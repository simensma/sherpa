...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('admin_image', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admin.Album'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Image.album'
        db.alter_column('admin_image', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['admin.Album']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 17, 14, 28, 2, 145247)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 17, 14, 28, 2, 144916)'}),
