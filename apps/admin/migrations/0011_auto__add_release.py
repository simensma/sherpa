...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('admin_release', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('publication', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admin.Publication'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('admin', ['Release'])

        # Adding M2M table for field tags on 'Release'
        db.create_table('admin_release_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('release', models.ForeignKey(orm['admin.release'], null=False)),
            ('tag', models.ForeignKey(orm['core.tag'], null=False))
        ))
        db.create_unique('admin_release_tags', ['release_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'Release'
        db.delete_table('admin_release')

        # Removing M2M table for field tags on 'Release'
        db.delete_table('admin_release_tags')
    ...
    models = {
        ...
        'admin.publication': {
            ...
            'logo': ('django.db.models.fields.CharField', [], {'max_length': '2048'}),
        ...
        'admin.release': {
            ...
            'publication': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['admin.Publication']"}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'releases'", 'symmetrical': 'False', 'to': "orm['core.Tag']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
