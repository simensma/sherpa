...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.photographer_alignment'
        db.add_column(u'admin_campaign', 'photographer_alignment',
                      self.gf('django.db.models.fields.CharField')(default='left', max_length=10),
                      keep_default=False)

        # Adding field 'Campaign.photographer_color'
        db.add_column(u'admin_campaign', 'photographer_color',
                      self.gf('django.db.models.fields.CharField')(default='white', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.photographer_alignment'
        db.delete_column(u'admin_campaign', 'photographer_alignment')

        # Deleting field 'Campaign.photographer_color'
        db.delete_column(u'admin_campaign', 'photographer_color')
