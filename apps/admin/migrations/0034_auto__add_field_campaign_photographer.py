...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.photographer'
        db.add_column(u'admin_campaign', 'photographer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.photographer'
        db.delete_column(u'admin_campaign', 'photographer')
