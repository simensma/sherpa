...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.button_position'
        db.add_column(u'admin_campaign', 'button_position',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.button_position'
        db.delete_column(u'admin_campaign', 'button_position')
