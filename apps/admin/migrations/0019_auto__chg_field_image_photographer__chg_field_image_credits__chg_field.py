...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'admin_image', 'photographer', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Image.credits'
        db.alter_column(u'admin_image', 'credits', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Image.licence'
        db.alter_column(u'admin_image', 'licence', self.gf('django.db.models.fields.CharField')(max_length=1023))

    def backwards(self, orm):

        # Changing field 'Image.photographer'
        db.alter_column(u'admin_image', 'photographer', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Image.credits'
        db.alter_column(u'admin_image', 'credits', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Image.licence'
        db.alter_column(u'admin_image', 'licence', self.gf('django.db.models.fields.CharField')(max_length=200))
