...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Publication.description'
        db.delete_column('admin_publication', 'description')

        # Deleting field 'Publication.pub_date'
        db.delete_column('admin_publication', 'pub_date')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Publication.description'
        raise RuntimeError("Cannot reverse this migration. 'Publication.description' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Publication.pub_date'
        raise RuntimeError("Cannot reverse this migration. 'Publication.pub_date' and its values cannot be restored.")
