...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.pdf_hash'
        db.add_column('admin_release', 'pdf_hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)

        # Adding field 'Release.online_view'
        db.add_column('admin_release', 'online_view',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.pdf_hash'
        db.delete_column('admin_release', 'pdf_hash')

        # Deleting field 'Release.online_view'
        db.delete_column('admin_release', 'online_view')
    ...
    models = {
        ...
        'admin.release': {
            ...
            'publication': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'releases'", 'to': "orm['admin.Publication']"}),
