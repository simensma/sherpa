...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        p = orm['auth.Permission'].objects.get(codename='sherpa')
        for user in orm['auth.User'].objects.all():
            user.user_permissions.add(p)

    def backwards(self, orm):
        print("Warning: Not removing sherpa-permissions.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 2, 16, 48, 48, 199743)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 2, 16, 48, 48, 199596)'}),
