...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.sherpa_email'
        db.add_column('user_profile', 'sherpa_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.sherpa_email'
        db.delete_column('user_profile', 'sherpa_email')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 6, 13, 33, 58, 91789)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 6, 13, 33, 58, 91575)'}),
