...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # I am the initial Sherpa admin :) POWER!!! -Ali
        profile = orm['user.Profile'].objects.get(memberid=3205691)
        user = profile.user
        permission = orm['auth.Permission'].objects.get(codename='sherpa_admin')
