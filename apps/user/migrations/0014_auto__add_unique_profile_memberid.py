...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Profile', fields ['memberid']
        db.create_unique('user_profile', ['memberid'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Profile', fields ['memberid']
        db.delete_unique('user_profile', ['memberid'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 30, 15, 9, 44, 811340)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 30, 15, 9, 44, 810949)'}),
