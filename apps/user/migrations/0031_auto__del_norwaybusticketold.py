...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'NorwayBusTicketOld'
        db.delete_table(u'user_norwaybusticketold')


    def backwards(self, orm):
        # Adding model 'NorwayBusTicketOld'
        db.create_table(u'user_norwaybusticketold', (
            ('distance', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('date_trip_text', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('memberid', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('date_placed', self.gf('django.db.models.fields.DateTimeField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'user', ['NorwayBusTicketOld'])
