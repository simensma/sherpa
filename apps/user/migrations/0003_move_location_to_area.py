...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for zipcode in orm['user.Zipcode'].objects.all():
            zipcode.area = zipcode.location
            zipcode.save()


    def backwards(self, orm):
        for zipcode in orm['user.Zipcode'].objects.all():
            zipcode.location = zipcode.area
            zipcode.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 11, 50, 38, 501618)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 11, 50, 38, 501468)'}),
