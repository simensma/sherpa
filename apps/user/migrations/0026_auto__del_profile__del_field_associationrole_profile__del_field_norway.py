...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('admin', '0022_auto__del_field_image_uploader'),
        ('aktiviteter', '0020_auto'),
        ('articles', '0019_auto__del_field_article_modified_by__del_field_article_created_by'),
        ('fjelltreffen', '0017_auto__del_field_annonse_profile'),
        ('membership', '0005_auto__del_field_smsservicerequest_profile'),
        ('page', '0026_auto__del_field_version_owner__del_field_variant_owner__del_field_page'),
    )
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AssociationRole.profile'
        db.delete_column(u'user_associationrole', 'profile_id')

        # Deleting field 'NorwayBusTicket.profile'
        db.delete_column(u'user_norwaybusticket', 'profile_id')


    def backwards(self, orm):
        # Adding model 'Profile'
        db.create_table(u'user_profile', (
            ('password_restore_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('password_restore_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('sherpa_email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('memberid', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True)),
        ))
        db.send_create_signal(u'user', ['Profile'])


        # User chose to not deal with backwards NULL issues for 'AssociationRole.profile'
        raise RuntimeError("Cannot reverse this migration. 'AssociationRole.profile' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'NorwayBusTicket.profile'
        raise RuntimeError("Cannot reverse this migration. 'NorwayBusTicket.profile' and its values cannot be restored.")
