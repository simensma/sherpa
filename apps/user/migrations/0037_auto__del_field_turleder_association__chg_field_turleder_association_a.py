...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Turleder.association'
        db.delete_column(u'user_turleder', 'association_id')


        # Changing field 'Turleder.association_approved'
        db.alter_column(u'user_turleder', 'association_approved_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['association.Association']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Turleder.association'
        raise RuntimeError("Cannot reverse this migration. 'Turleder.association' and its values cannot be restored.")

        # Changing field 'Turleder.association_approved'
        db.alter_column(u'user_turleder', 'association_approved_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['association.Association']))
    ...
    models = {
        ...
        u'user.turleder': {
            ...
            'association_approved': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'association_approved'", 'to': u"orm['association.Association']"}),
