...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        association = orm['association.Association'].objects.get(name='Den Norske Turistforening') # Should always be only one
        for profile in orm['user.Profile'].objects.all():
            profile.associations.add(association)

    def backwards(self, orm):
        for profile in orm['user.Profile'].objects.all():
            profile.associations.clear()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 2, 13, 57, 12, 901117)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 2, 13, 57, 12, 900915)'}),
