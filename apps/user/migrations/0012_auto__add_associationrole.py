...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('user_associationrole', (
        ...
        db.send_create_signal('user', ['AssociationRole'])
        ...
        for user in orm['auth.User'].objects.all():
            role = orm['user.AssociationRole'](profile=user.profile, association=association, role='user')
            role.save()

    def backwards(self, orm):
        
        # Deleting model 'AssociationRole'
        db.delete_table('user_associationrole')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 14, 14, 52, 29, 884987)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 14, 14, 52, 29, 884825)'}),
