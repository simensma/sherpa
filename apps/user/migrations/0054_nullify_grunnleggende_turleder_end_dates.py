...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for turleder in orm['user.Turleder'].objects.filter(role='grunnleggende'):
    ...
    models = {
        ...
        u'user.turleder': {
            ...
            'date_end': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'date_start': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'forening_approved': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'turledere_approved'", 'to': u"orm['foreninger.Forening']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'role': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
