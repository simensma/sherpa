...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Instruktor'
        db.create_table(u'user_instruktor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='instruktor', to=orm['user.User'])),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'user', ['Instruktor'])

        # Deleting field 'User.instruktor_roles'
        db.delete_column(u'user_user', 'instruktor_roles')


    def backwards(self, orm):
        # Deleting model 'Instruktor'
        db.delete_table(u'user_instruktor')

        # Adding field 'User.instruktor_roles'
        db.add_column(u'user_user', 'instruktor_roles',
                      self.gf('django.db.models.fields.CharField')(default='{"politi": false, "klatre": false, "skred": false, "snowboard": false, "telemark": false, "bre": false, "padle": false, "senior": false, "ungdom": false, "barn": false}', max_length=4095),
                      keep_default=False)
