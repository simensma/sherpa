...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Kursleder'
        db.create_table(u'user_kursleder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='kursleder', unique=True, to=orm['user.User'])),
        ...
        db.send_create_signal(u'user', ['Kursleder'])


    def backwards(self, orm):
        # Deleting model 'Kursleder'
        db.delete_table(u'user_kursleder')
