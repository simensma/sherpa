...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.pending_registration_key'
        db.add_column(u'user_user', 'pending_registration_key',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.pending_registration_key'
        db.delete_column(u'user_user', 'pending_registration_key')
