...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssociationRole.user'
        db.alter_column(u'user_associationrole', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['user.User']))

        # Changing field 'NorwayBusTicket.user'
        db.alter_column(u'user_norwaybusticket', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, unique=True, to=orm['user.User']))

    def backwards(self, orm):

        # Changing field 'AssociationRole.user'
        db.alter_column(u'user_associationrole', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User'], null=True))

        # Changing field 'NorwayBusTicket.user'
        db.alter_column(u'user_norwaybusticket', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['user.User']))
