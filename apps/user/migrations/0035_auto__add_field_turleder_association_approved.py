...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Turleder.association_approved'
        db.add_column(u'user_turleder', 'association_approved',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='association_approved', null=True, to=orm['association.Association']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Turleder.association_approved'
        db.delete_column(u'user_turleder', 'association_approved_id')
    ...
    models = {
        ...
        u'user.turleder': {
            ...
            'association_approved': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'association_approved'", 'null': 'True', 'to': u"orm['association.Association']"}),
