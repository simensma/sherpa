...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field permissions on 'User'
        db.create_table(u'user_user_permissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'user.user'], null=False)),
            ('permission', models.ForeignKey(orm[u'user.permission'], null=False))
        ))
        db.create_unique(u'user_user_permissions', ['user_id', 'permission_id'])

        # Adding model 'Permission'
        db.create_table(u'user_permission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'user', ['Permission'])

        # Adding field 'AssociationRole.user'
        db.add_column(u'user_associationrole', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User'], null=True),
                      keep_default=False)

        # Adding field 'NorwayBusTicket.user'
        db.add_column(u'user_norwaybusticket', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='new_norway_bus_ticket', unique=True, null=True, to=orm['user.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field permissions on 'User'
        db.delete_table('user_user_permissions')

        # Deleting model 'Permission'
        db.delete_table(u'user_permission')

        # Deleting field 'AssociationRole.user'
        db.delete_column(u'user_associationrole', 'user_id')

        # Deleting field 'NorwayBusTicket.user'
        db.delete_column(u'user_norwaybusticket', 'user_id')
