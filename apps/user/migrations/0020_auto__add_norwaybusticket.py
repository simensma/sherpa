...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NorwayBusTicket'
        db.create_table('user_norwaybusticket', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(related_name='norway_bus_ticket', unique=True, to=orm['user.Profile'])),
            ('date_placed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_trip', self.gf('django.db.models.fields.DateTimeField')()),
            ('distance', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal('user', ['NorwayBusTicket'])


    def backwards(self, orm):
        # Deleting model 'NorwayBusTicket'
        db.delete_table('user_norwaybusticket')
