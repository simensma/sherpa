...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Turleder'
        db.create_table(u'user_turleder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='turledere', to=orm['user.User'])),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('association', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['association.Association'])),
        ...
        db.send_create_signal(u'user', ['Turleder'])


    def backwards(self, orm):
        # Deleting model 'Turleder'
        db.delete_table(u'user_turleder')
