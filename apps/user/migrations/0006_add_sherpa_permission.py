...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        create_permissions(get_app('user'), get_models(), 2)

    def backwards(self, orm):
        print("Warning: Unable to reverse this migration")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 16, 23, 17, 503854)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 5, 16, 23, 17, 503702)'}),
