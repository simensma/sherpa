...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NorwayBusTicket.date_trip_text'
        db.add_column(u'user_norwaybusticket', 'date_trip_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'NorwayBusTicket.is_imported'
        db.add_column(u'user_norwaybusticket', 'is_imported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'NorwayBusTicket.date_trip'
        db.alter_column(u'user_norwaybusticket', 'date_trip', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'NorwayBusTicket.date_trip_text'
        db.delete_column(u'user_norwaybusticket', 'date_trip_text')

        # Deleting field 'NorwayBusTicket.is_imported'
        db.delete_column(u'user_norwaybusticket', 'is_imported')


        # User chose to not deal with backwards NULL issues for 'NorwayBusTicket.date_trip'
        raise RuntimeError("Cannot reverse this migration. 'NorwayBusTicket.date_trip' and its values cannot be restored.")
