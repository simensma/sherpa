...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for forening in orm['foreninger.Forening'].objects.all():
            try:
                sherpa2_forening = orm['sherpa2.Forening'].objects.get(id=forening.id)
            except orm['sherpa2.Forening'].DoesNotExist:
                continue

            if sherpa2_forening.county == '' or sherpa2_forening.county is None:
                continue

            forening.counties.clear()
