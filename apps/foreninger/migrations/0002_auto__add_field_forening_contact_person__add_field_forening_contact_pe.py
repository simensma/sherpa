...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forening.contact_person'
        db.add_column(u'foreninger_forening', 'contact_person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User'], null=True),
                      keep_default=False)

        # Adding field 'Forening.contact_person_name'
        db.add_column(u'foreninger_forening', 'contact_person_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forening.contact_person'
        db.delete_column(u'foreninger_forening', 'contact_person_id')

        # Deleting field 'Forening.contact_person_name'
        db.delete_column(u'foreninger_forening', 'contact_person_name')
