...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Forening.parent'
        db.delete_column(u'foreninger_forening', 'parent_id')


    def backwards(self, orm):
        # Adding field 'Forening.parent'
        db.add_column(u'foreninger_forening', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', null=True, to=orm['foreninger.Forening']),
                      keep_default=False)
