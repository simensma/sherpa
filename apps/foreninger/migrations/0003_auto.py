...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field parents on 'Forening'
        db.create_table(u'foreninger_forening_parents', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_forening', models.ForeignKey(orm[u'foreninger.forening'], null=False)),
            ('to_forening', models.ForeignKey(orm[u'foreninger.forening'], null=False))
        ))
        db.create_unique(u'foreninger_forening_parents', ['from_forening_id', 'to_forening_id'])


    def backwards(self, orm):
        # Removing M2M table for field parents on 'Forening'
        db.delete_table('foreninger_forening_parents')
    ...
    models = {
        ...
        u'foreninger.forening': {
            ...
            'parents': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'children_tmp'", 'symmetrical': 'False', 'to': u"orm['foreninger.Forening']"}),
