...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SMSServiceRequest.blocked'
        db.add_column('membership_smsservicerequest', 'blocked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SMSServiceRequest.blocked'
        db.delete_column('membership_smsservicerequest', 'blocked')
