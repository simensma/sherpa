...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SMSServiceRequest'
        db.create_table('membership_smsservicerequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.Profile'], null=True)),
            ('ip', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('count', self.gf('django.db.models.fields.IntegerField')()),
            ('phone_number_input', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('memberid', self.gf('django.db.models.fields.IntegerField')(max_length=255, null=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('membership', ['SMSServiceRequest'])


    def backwards(self, orm):
        # Deleting model 'SMSServiceRequest'
        db.delete_table('membership_smsservicerequest')
    ...
    models = {
        ...
        'membership.smsservicerequest': {
            ...
            'phone_number_input': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user.Profile']", 'null': 'True'})
        },
