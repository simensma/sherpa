...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SMSServiceRequest.phone_number_input'
        db.alter_column(u'membership_smsservicerequest', 'phone_number_input', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SMSServiceRequest.phone_number_input'
        raise RuntimeError("Cannot reverse this migration. 'SMSServiceRequest.phone_number_input' and its values cannot be restored.")
