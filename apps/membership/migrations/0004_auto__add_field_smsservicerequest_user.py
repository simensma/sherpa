...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SMSServiceRequest.user'
        db.add_column(u'membership_smsservicerequest', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SMSServiceRequest.user'
        db.delete_column(u'membership_smsservicerequest', 'user_id')
