...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SMSServiceRequest.profile'
        db.delete_column(u'membership_smsservicerequest', 'profile_id')


    def backwards(self, orm):
        # Adding field 'SMSServiceRequest.profile'
        db.add_column(u'membership_smsservicerequest', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.Profile'], null=True),
                      keep_default=False)
