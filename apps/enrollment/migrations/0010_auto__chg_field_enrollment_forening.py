...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Enrollment.forening' to match new field type.
        db.rename_column(u'enrollment_enrollment', 'forening', 'forening_id')
        # Changing field 'Enrollment.forening'
        db.alter_column(u'enrollment_enrollment', 'forening_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['foreninger.Forening']))
        # Adding index on 'Enrollment', fields ['forening']
        db.create_index(u'enrollment_enrollment', ['forening_id'])

        for enrollment in orm['enrollment.Enrollment'].objects.all():
            if enrollment.forening_tmp is not None:
                enrollment.forening = orm['foreninger.Forening'].objects.get(id=enrollment.forening_tmp)
                enrollment.save()

    def backwards(self, orm):
        # Removing index on 'Enrollment', fields ['forening']
        db.delete_index(u'enrollment_enrollment', ['forening_id'])


        # Renaming column for 'Enrollment.forening' to match new field type.
        db.rename_column(u'enrollment_enrollment', 'forening_id', 'forening')
        # Changing field 'Enrollment.forening'
        db.alter_column(u'enrollment_enrollment', 'forening', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'enrollment.enrollment': {
            ...
            'forening_tmp': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
