...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageVariant.publisher'
        db.add_column('page_pagevariant', 'publisher', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['user.Profile']), keep_default=False)
        ...
        # Adding field 'PageVersion.publisher'
        db.add_column('page_pageversion', 'publisher', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['user.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PageVariant.publisher'
        db.delete_column('page_pagevariant', 'publisher_id')

        # Deleting field 'Page.publisher'
        db.delete_column('page_page', 'publisher_id')

        # Deleting field 'PageVersion.publisher'
        db.delete_column('page_pageversion', 'publisher_id')
