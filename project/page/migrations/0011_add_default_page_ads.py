...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for version in orm.Version.objects.filter(variant__page__slug__in=self.slugs):
            version.ads = True
            version.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 13, 23, 54, 993875)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 13, 23, 54, 993719)'}),
