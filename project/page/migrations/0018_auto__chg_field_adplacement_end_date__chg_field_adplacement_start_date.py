...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('page_adplacement', 'end_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'AdPlacement.start_date'
        db.alter_column('page_adplacement', 'start_date', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'AdPlacement.end_date'
        db.alter_column('page_adplacement', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'AdPlacement.start_date'
        db.alter_column('page_adplacement', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 14, 20, 15, 37, 118145)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 14, 20, 15, 37, 117969)'}),
