...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Ad.type'
        db.delete_column('page_ad', 'type')

        # Adding field 'Ad.content_type'
        db.add_column('page_ad', 'content_type', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Ad.type'
        db.add_column('page_ad', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Deleting field 'Ad.content_type'
        db.delete_column('page_ad', 'content_type')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 14, 14, 0, 29, 155199)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 14, 14, 0, 29, 155017)'}),
