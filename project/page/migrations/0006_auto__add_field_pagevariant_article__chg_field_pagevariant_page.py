...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageVariant.article'
        db.add_column('page_pagevariant', 'article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Article'], null=True), keep_default=False)

        # Changing field 'PageVariant.page'
        db.alter_column('page_pagevariant', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['page.Page'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'PageVariant.article'
        db.delete_column('page_pagevariant', 'article_id')

        # User chose to not deal with backwards NULL issues for 'PageVariant.page'
        raise RuntimeError("Cannot reverse this migration. 'PageVariant.page' and its values cannot be restored.")
