...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('page_page', 'title', self.gf('django.db.models.fields.CharField')(default='Side uten tittel, fra migrering', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.title'
        db.delete_column('page_page', 'title')
