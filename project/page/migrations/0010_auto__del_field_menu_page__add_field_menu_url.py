...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('page_menu', 'page_id')

        # Adding field 'Menu.url'
        db.add_column('page_menu', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=2048), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Menu.page'
        db.add_column('page_menu', 'page', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['page.Page'], unique=True), keep_default=False)

        # Deleting field 'Menu.url'
        db.delete_column('page_menu', 'url')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 16, 11, 0, 3, 232742)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 16, 11, 0, 3, 232565)'}),
