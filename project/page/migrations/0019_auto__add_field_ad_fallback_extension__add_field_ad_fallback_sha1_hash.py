...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ad.fallback_extension'
        db.add_column('page_ad', 'fallback_extension', self.gf('django.db.models.fields.CharField')(default=None, max_length=4, null=True), keep_default=False)

        # Adding field 'Ad.fallback_sha1_hash'
        db.add_column('page_ad', 'fallback_sha1_hash', self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True), keep_default=False)

        # Adding field 'Ad.fallback_content_type'
        db.add_column('page_ad', 'fallback_content_type', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ad.fallback_extension'
        db.delete_column('page_ad', 'fallback_extension')

        # Deleting field 'Ad.fallback_sha1_hash'
        db.delete_column('page_ad', 'fallback_sha1_hash')

        # Deleting field 'Ad.fallback_content_type'
        db.delete_column('page_ad', 'fallback_content_type')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 3, 15, 4, 26, 177012)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 3, 15, 4, 26, 176839)'}),
        ...
        'page.ad': {
            ...
            'fallback_content_type': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True'}),
            'fallback_extension': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '4', 'null': 'True'}),
            'fallback_sha1_hash': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '40', 'null': 'True'}),
