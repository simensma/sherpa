...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Variant.owner'
        db.add_column('page_variant', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='+', to=orm['user.Profile']), keep_default=False)

        # Adding field 'Version.owner'
        db.add_column('page_version', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['user.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Variant.owner'
        db.delete_column('page_variant', 'owner_id')

        # Deleting field 'Version.owner'
        db.delete_column('page_version', 'owner_id')
    ...
    models = {
        ...
        'articles.article': {
            ...
            'publishers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'articles'", 'symmetrical': 'False', 'to': "orm['user.Profile']"}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 28, 9, 52, 38, 42550)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 28, 9, 52, 38, 42315)'}),
        ...
        'page.version': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user.Profile']"}),
            'publisher': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['user.Profile']"}),
