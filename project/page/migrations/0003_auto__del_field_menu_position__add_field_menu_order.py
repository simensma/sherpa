...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Menu.position'
        db.delete_column('page_menu', 'position')

        # Adding field 'Menu.order'
        db.add_column('page_menu', 'order', self.gf('django.db.models.fields.IntegerField')(default=-1, unique=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Menu.position'
        db.add_column('page_menu', 'position', self.gf('django.db.models.fields.IntegerField')(default=-1, unique=True), keep_default=False)

        # Deleting field 'Menu.order'
        db.delete_column('page_menu', 'order')
