...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Remove all 'editor' widgets (byline). It will now be rendered by the article renderer
        import json
        for widget in orm.Content.objects.filter(type='widget'):
            if json.loads(widget.content)['widget'] == 'editor':
                widget.delete()


    def backwards(self, orm):
        # Don't recreate the widgets.
        pass
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 7, 12, 1, 11, 791880)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 7, 12, 1, 11, 791710)'}),
