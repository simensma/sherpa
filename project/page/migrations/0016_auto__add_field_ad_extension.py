...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ad.extension'
        db.add_column('page_ad', 'extension', self.gf('django.db.models.fields.CharField')(default='', max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ad.extension'
        db.delete_column('page_ad', 'extension')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 14, 14, 4, 59, 299974)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 14, 14, 4, 59, 299803)'}),
