...
class Actor(models.Model):
    ...
    nm = models.CharField(max_length=50, db_column=u'Nm', blank=True)
    finm = models.CharField(max_length=50, db_column=u'FiNm', blank=True)
...
class ActorAddress(models.Model):
    ...
    pcode = models.CharField(max_length=9, db_column=u'PCode', blank=True)
    parea = models.CharField(max_length=30, db_column=u'PArea', blank=True)
    ctrycode = models.CharField(max_length=3, db_column=u'CtryCode', blank=True)
