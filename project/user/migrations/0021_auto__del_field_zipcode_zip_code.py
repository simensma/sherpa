...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('user_zipcode', 'zip_code', self.gf('django.db.models.fields.CharField')(default='', max_length=4), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 16, 49, 27, 962606)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 16, 49, 27, 962328)'}),
