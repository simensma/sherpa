...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Zipcode.zipcode'
        db.add_column('user_zipcode', 'zipcode', self.gf('django.db.models.fields.CharField')(default='', max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Zipcode.zipcode'
        db.delete_column('user_zipcode', 'zipcode')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 16, 48, 10, 667153)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 16, 48, 10, 666994)'}),
