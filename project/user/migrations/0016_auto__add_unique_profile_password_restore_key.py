...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Profile', fields ['password_restore_key']
        db.create_unique('user_profile', ['password_restore_key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Profile', fields ['password_restore_key']
        db.delete_unique('user_profile', ['password_restore_key'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 6, 12, 44, 48, 455450)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 6, 12, 44, 48, 455256)'}),
