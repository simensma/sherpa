...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('user_profile', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('user_profile', 'phone')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 5, 20, 55, 26, 111251)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 5, 20, 55, 26, 111068)'}),
