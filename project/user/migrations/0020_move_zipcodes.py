...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Move stuff over
        print("   Moving all zipcodes from column to column, this could take a while :)")
        for zipcode in orm['user.Zipcode'].objects.all():
    ...
    def backwards(self, orm):
        ...
        print("   Moving all zipcodes from column to column, this could take a while :)")
        for zipcode in orm['user.Zipcode'].objects.all():
            zipcode.zip_code = zipcode.zipcode
            zipcode.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 16, 48, 23, 2596)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 16, 48, 23, 2444)'}),
