...
urlpatterns = patterns('',
    ...
    url(ur'^bcp/(?P<slug>.*)', 'page.views.redirect', kwargs={'url': 'http://preikestolen_basecamp.turistforeningen.no/', 'permanent': True}),
    url(ur'^preikestolenbasecamp/(?P<slug>.*)', 'page.views.redirect', kwargs={'url': 'http://preikestolen_basecamp.turistforeningen.no/', 'permanent': True}),
    ...
    url(r'^aot/(?P<slug>.*)', 'page.views.redirect', kwargs={'url': 'http://aust-agder.turistforeningen.no/'}),
    url(r'^aat/(?P<slug>.*)', 'page.views.redirect', kwargs={'url': 'http://aust-agder.turistforeningen.no/'}),
    url(r'^austagder/$', 'page.views.redirect', kwargs={'url': 'http://aust-agder.turistforeningen.no/'}),
    url(r'^bodo/$', 'page.views.redirect', kwargs={'url': 'http://www.bot.no/'}),
    url(r'^bronnoy/$', 'page.views.redirect', kwargs={'url': 'http://bronnoysund.turistforeningen.no/'}),
    ...
    url(r'^fredrikstad/$', 'page.views.redirect', kwargs={'url': 'http://nedreglomma.turistforeningen.no/'}),
    url(r'^go/$', 'page.views.redirect', kwargs={'url': 'http://gjovik.turistforeningen.no/'}),
    url(r'^gtt/$', 'page.views.redirect', kwargs={'url': 'http://gjovik.turistforeningen.no/'}),
    url(r'^harstad/$', 'page.views.redirect', kwargs={'url': 'http://www.harstad-turlag.no'}),
    url(r'^httur/$', 'page.views.redirect', kwargs={'url': 'http://haugesund.turistforeningen.no/'}),
    url(r'^preikestolhytta/$', 'page.views.redirect', kwargs={'url': 'http://www.preikestolenfjellstue.no'}),
    url(r'^preikestolenfjellstue/$', 'page.views.redirect', kwargs={'url': 'http://www.preikestolenfjellstue.no'}),
    url(r'^sel/$', 'page.views.redirect', kwargs={'url': 'http://gudbrandsdalen.turistforeningen.no/'}),
    url(r'^skientelemark/$', 'page.views.redirect', kwargs={'url': 'http://skientelemark.turistforeningen.no/'}),
    url(r'^smaalenene/$', 'page.views.redirect', kwargs={'url': 'http://indreostfold.turistforeningen.no/'}),
    url(r'^snoheim/$', 'page.views.redirect', kwargs={'url': 'http://snoheim.turistforeningen.no/'}),
    url(r'^sot/$', 'page.views.redirect', kwargs={'url': 'http://sulitjelma.turistforeningen.no/'}),
    url(r'^sotaseter2/$', 'page.views.redirect', kwargs={'url': 'http://sotaseter.turistforeningen.no/'}),
    url(r'^stavanger/(?P<slug>.*)', 'page.views.redirect', kwargs={'url': 'http://www.stavanger-turistforening.no/'}),
    url(r'^tromsturlag/$', 'page.views.redirect', kwargs={'url': 'http://troms.turistforeningen.no/'}),
    url(r'^telemark/ung/$', 'page.views.redirect', kwargs={'url': 'http://www.dntung.no/telemark/'}),
    url(r'^troms/barn/$', 'page.views.redirect', kwargs={'url': 'http://troms.turistforeningen.no/group.php', 'params': {'gr_id': '183'}}),
    url(r'^strandalshytta/$', 'page.views.redirect', kwargs={'url': 'http://stranddalshytta.turistforeningen.no/'}),
    url(r'^yst/$', 'page.views.redirect', kwargs={'url': 'http://ytresogn.turistforeningen.no/'}),
    ...
    url(r'^intranett/$', 'page.views.redirect', kwargs={'url': 'http://foreningsnett.turistforeningen.no/'}),
    url(r'^ist/$', 'page.views.redirect', kwargs={'url': 'http://www.istur.no/'}),
    url(r'^kvistekart/$', 'page.views.redirect', kwargs={'url': '/vintermerking/'}),
    ...
    url(r'^profil/$', 'page.views.redirect', kwargs={'url': 'http://foreningsnett.turistforeningen.no/file.php', 'params': {'dir': '/Kommunikasjon/Profilprogram', 'fo_id': '6691'}}),
    url(r'^profilprogram/$', 'page.views.redirect', kwargs={'url': 'http://foreningsnett.turistforeningen.no/file.php', 'params': {'dir': '/Kommunikasjon/Profilprogram', 'fo_id': '6691'}}),
