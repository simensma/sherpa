...
urlpatterns = patterns('',
    ...
    url(r'^nettbutikk/$', 'page.views.perform_redirect', kwargs={'url': 'http://nettbutikken.turistforeningen.no/eshop'}),
    ...
    url(r'^verving/$', 'page.views.perform_redirect', kwargs={'url': 'http://%s/form2.php' % settings.OLD_SITE, 'params': {'form': 'verving'}}),
    ...
    url(r'^kartbutikken/$', 'page.views.perform_redirect', kwargs={'url': 'http://www.nettbutikken.dntoslo.no/eshop'}),
    url(r'^kartbutikk/$', 'page.views.perform_redirect', kwargs={'url': 'http://www.nettbutikken.dntoslo.no/eshop/main.aspx?guest=yes'}),
    ...
    url(r'^fotokonkurranse/$', 'page.views.perform_redirect', kwargs={'url': 'http://%s/form2.php' % settings.OLD_SITE, 'params': {'form': 'fotokonkurranse'}}),
    url(r'^engerdalogtrysil/$', 'page.views.perform_redirect', kwargs={'url': 'http://%s/group.php' % settings.OLD_SITE, 'params': {'gr_id': '16', 'fo_id': '128'}}),
