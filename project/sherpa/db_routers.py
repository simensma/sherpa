class Router(object):
    ...
    def db_for_write(self, model, **hints):
        if model._meta.object_name in ['Association', 'Actor', 'ActorAddress', 'FocusZipcode', 'FocusPrice']:
    ...
    def allow_syncdb(self, db, model):
        if model._meta.object_name in ['Association', 'FocusUser', 'Actor', 'ActorAddress', 'FocusZipcode', 'FocusPrice']:
            return False
