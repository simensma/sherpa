...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.licence'
        db.add_column('admin_image', 'licence', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'Image.exif'
        db.add_column('admin_image', 'exif', self.gf('django.db.models.fields.TextField')(default='[]'), keep_default=False)

        # Changing field 'Image.description'
        db.alter_column('admin_image', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Image.licence'
        db.delete_column('admin_image', 'licence')

        # Deleting field 'Image.exif'
        db.delete_column('admin_image', 'exif')

        # Changing field 'Image.description'
        db.alter_column('admin_image', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'admin.image': {
            ...
            'licence': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
