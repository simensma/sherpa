...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('admin_image', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.description'
        db.delete_column('admin_image', 'description')
