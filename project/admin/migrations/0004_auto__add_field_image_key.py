...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.key'
        db.add_column('admin_image', 'key', self.gf('django.db.models.fields.CharField')(default='', max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.key'
        db.delete_column('admin_image', 'key')
