...
def new(request):
    ...
    contents = [
        {'type': 'html', 'content': """<div class="editable"><h1>Fengende overskrift</h1></div><img class="changeable" src=\"""" + settings.STATIC_URL + """img/article/placeholder-top.png" alt="placeholder"><br><div class="editable">BILDETEKST: Nunc diam velit, adipiscing ut tristique vitae, sagittis vel odio. Maecenas convallis.<br><em>Foto: Ola Nordmann/DNT</em></div>"""},
        {'type': 'html', 'content': """<div class="lede editable"><p>Suspendisse lectus leo, consectetur in tempor sit amet, placerat quis neque. Etiam luctus porttitor lorem, sed suscipit est rutrum non. Curabitur lobortis nisl a enim congue semper. Aenean commodo ultrices imperdiet.</p></div>"""},
        ...
        {'type': 'html', 'content': """<img class="changeable" src=\"""" + settings.STATIC_URL + """img/article/placeholder-bottom.png" alt="placeholder"><br><div class="editable">BILDETEKST: Donec ut libero sed arcu vehicula.<br><em>Foto: Kari Nordmann/DNT</em></div>"""},
    ]
