...
def new(request):
    ...
    contents = [
        ...
        {'type': 'image', 'content': """<img src=\"""" + settings.STATIC_URL + """img/article/placeholder-top.png" alt="placeholder">"""},
        ...
        {'type': 'image', 'content': """<img class="changeable" src=\"""" + settings.STATIC_URL + """img/article/placeholder-bottom.png" alt="placeholder">"""},
